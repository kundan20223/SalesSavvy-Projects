...
public class kodusers {
   ...
   @Override
   public int hashCode() {
	return Objects.hash(Integer.valueOf(age), Integer.valueOf(kodid), Integer.valueOf(marks), password, role, username);
   }
   ...
   public boolean equals(Object obj) {
	...
	return age == other.age && kodid == other.kodid && marks == other.marks && Objects.equals(password, other.password)
